...
import s from "../components/patients/index.module.scss";
            ...
            <main className={styles.main}>
                <div id="wrapper">
                    ...
                    <div id="page-wrapper" className="gray-bg">
                        <PageHeading pageName={'Privacy Policy'}/>
                                ...
                                <div className="col-lg-12 tab-seeContent">
                                    <div className="ibox">
                                        <div className={`${s.boxTitle} ibox-title`}>
                                            ...
                                            <ul>
                                                <li>
                                                    <p><strong>Account</strong> means a unique account created for You
                                                        to
                                                        access our Service
                                                ...
                                                <li>
                                                    <p><strong>Company</strong> (referred to as either &quot;the
                                                        ...
                                                        this Agreement)
                                                        refers to Metz, Kub and Green, Fugit voluptatem et porro veniam
                                                        et
                                                        incidunt..</p>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <p><strong>Website</strong> refers to Minima repellat itaque aliquam
                                                        non
                                                        dolores.,
                                                        accessible from [Molestiae quas facere debitis ut natus autem
                                                        nulla
                                                        veniam
                                                        atque.](Molestiae quas facere debitis ut natus autem nulla
                                                        veniam
                                                        atque.)</p>
                                                </li>
                                                <li>
                                            ...
                                            <ul>
                                                <li><strong>Cookies or Browser Cookies.</strong> A cookie is a small
                                                    ...
                                                    able to use some
                                                    parts of our Service. Unless you have adjusted Your browser setting
                                                    so
                                                    that it will
                                                ...
                                                <li><strong>Flash Cookies.</strong> Certain features of our Service may
                                                    ...
                                                    can
                                                    delete Flash
                                                    Cookies, please read &quot;Where can I change the settings for
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <p>Purpose: These Cookies are essential to provide You with services
                                                        available through
                                                        the Website and to enable You to use some of its features. They
                                                        help
                                                        to authenticate
                                            ...
                                            <ul>
                                                <li>
                                                    <p><strong>To provide and maintain our Service</strong>, including
                                                        to
                                                        monitor the usage
                                                        of our Service.</p>
                                                </li>
                                                ...
                                                <li>
                                                    <p><strong>To provide You</strong> with news, special offers and
                                                        ...
                                                        you have already purchased or enquired about unless You have
                                                        opted
                                                        not to receive
                                                        such information.</p>
                                                </li>
                                                <li>
                                                    <p><strong>To manage Your requests:</strong> To attend and manage
                                                        Your
                                                        requests to Us.
                                                    </p>
                                                </li>
                                            ...
                                            <ul>
                                                <li>
                                                    <p>By email: support@phi.com</p>
                                                </li>
                                                <li>
                                                    <p>By phone number: Quo facere sunt dolorem reiciendis impedit vero
                                                        esse
                                                        consequuntur est.</p>
                                                </li>
                                                <li>
                                                    <p>By mail: Autem saepe asperiores sed.</p>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
